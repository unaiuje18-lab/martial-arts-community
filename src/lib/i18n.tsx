...
const dict = {
  en: {
    ...
    "onb.progress": "Profile completion",
    "onb.fix": "Complete the highlighted fields to continue.",
    "onb.err.name": "Add your name.",
    "onb.err.username": "Pick a username.",
    "onb.err.birthday": "Add your birthday.",
    "onb.err.age": "You must be at least 5 years old.",
    "onb.err.arts": "Pick at least one discipline.",
    "onb.err.level": "Pick your skill level.",
    "onb.err.prefs": "Pick at least one interest.",
  ...
  es: {
    ...
    "onb.progress": "Perfil completado",
    "onb.fix": "Completa los campos resaltados para continuar.",
    "onb.err.name": "Añade tu nombre.",
    "onb.err.username": "Elige un usuario.",
    "onb.err.birthday": "Añade tu cumpleaños.",
    "onb.err.age": "Debes tener al menos 5 años.",
    "onb.err.arts": "Elige al menos una disciplina.",
    "onb.err.level": "Elige tu nivel.",
    "onb.err.prefs": "Elige al menos un interés.",
